...
class StakeHolders extends StatefulWidget {
  ...
  @override
  State<StakeHolders> createState() => _StakeHoldersState();
}
...
class _StakeHoldersState extends State<StakeHolders> {
  ...
  Widget usersMobile() {
    return Scaffold(
        appBar: AppBar(
          title: const Text("stakeholders").tr(),
        ),
  ...
  Widget usersDesktop() {
    return Scaffold(
        body: Column(
          children: [
            AppHeader(
                searchHint: 'search_stakeholders', onChanged: (value) => onSearch(value),
                onSearch:(){ setState(() {
                  Env.searchOn = true;
                });
                },
              ...
              child: Container(
                ...
                child: _foundedUsers.isNotEmpty
                    ...
                    child: Column(
                      ...
                      children: [
                        Image.asset('assets/empty.png',color: kGrey,width: 100,),
                        const SizedBox(height: 20),
                        const Text("no_data_found",style: TextStyle(color: kWhite),).tr()
                      ],
                    )),
              ),
            ),
                ...
                child: ClipRRect(
                    ...
                    child: CachedNetworkImage(
                      ...
                      errorWidget: (context, url, error) =>
                          Image.asset('assets/ghufran.jpg'),
                      imageUrl: user.image,
                    ))),
